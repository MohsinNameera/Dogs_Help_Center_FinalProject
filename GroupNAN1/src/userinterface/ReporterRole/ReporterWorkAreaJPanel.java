 ...
 * @author MyPC1
 */
public class ReporterWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public ReporterWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecosystem) {
        //this.set
    ...
    private void initComponents() {
        ...
        placeOrderLabel.setText("Report ");
        ...
        jPanel1.add(placeOrderButtonPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 280, -1));
        ...
        orderStatusLabel.setForeground(new java.awt.Color(51, 51, 51));
        orderStatusLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        orderStatusLabel.setText("Report Status");
        ...
        orderStatusButtonPanelLayout.setVerticalGroup(
            ...
            .addGroup(orderStatusButtonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(orderStatusLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
                .addContainerGap())
        );

        jPanel1.add(orderStatusButtonPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 280, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reportersys.png"))); // NOI18N
    ...
    private void placeOrder() {
        ...
        orderStatusButtonPanel.setBackground(new Color(255,204,0));
    ...
    private void orderStatus() {
        ...
        placeOrderButtonPanel.setBackground(new Color(255,204,0));
