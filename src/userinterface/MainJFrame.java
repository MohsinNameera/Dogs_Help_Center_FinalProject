...
//        changePanel(userAccount);
    ...
    private void changePanel(UserAccount userAccount) {
        if (userAccount != null) {
            String greetings = "Hi";
            if (userAccount instanceof Reporter){
                    greetings =  greetings + " " + ((Reporter)userAccount).getName();
                    container.add("workArea", userAccount.getRole().createWorkArea(container, (Reporter)userAccount, system));
            }else if(userAccount instanceof HelpCenter){
                    greetings =  greetings + " " + ((HelpCenter)userAccount).getName();
                    container.add("workArea", userAccount.getRole().createWorkArea(container, (HelpCenter)userAccount, system));
            }else if(userAccount instanceof RescueTeam){
                    greetings =  greetings + " " + ((RescueTeam)userAccount).getName();
                    container.add("workArea", userAccount.getRole().createWorkArea(container, (RescueTeam)userAccount, system));
            }else{
    ...
    private void initComponents() {
        ...
        greetingUserLabel.setText("Welcome!!");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/mainLogoNAN1.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/d1.gif"))); // NOI18N
        ...
        loginJPanel.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/lk1.gif"))); // NOI18N
        ...
        userNameJTextField.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 18)); // NOI18N
        userNameJTextField.setForeground(new java.awt.Color(255, 255, 255));
        userNameJTextField.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 204, 0)));
        ...
        loginJPanel.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 296, 304, -1));
        ...
        passwordField.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 18)); // NOI18N
        passwordField.setForeground(new java.awt.Color(255, 255, 255));
        passwordField.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 204, 0)));
        ...
        loginJPanel.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 370, 304, -1));
        ...
        loginJPanel.add(loginButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 444, 304, 33));
        ...
        loginJPanel.add(cancelButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1158, 11, -1, 35));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/main3.png"))); // NOI18N
        loginJPanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(621, 113, 161, 143));
