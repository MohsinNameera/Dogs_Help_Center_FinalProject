...
import userinterface.HelpCenterAdminRole.ManageOrderDetailsJPanel;

/**
 *
 * @author raunak
 */
public class RescueTeamWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public RescueTeamWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem ecosystem) {
        initComponents();
        initListners();
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof OrderWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           ProcessRequestJPanel processOrderJPanel = new ProcessRequestJPanel(userProcessContainer,ecosystem,userAccount,orderWorkRequest);
    ...
    private void initComponents() {
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, 760, 230));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Rescueteam.png"))); // NOI18N
