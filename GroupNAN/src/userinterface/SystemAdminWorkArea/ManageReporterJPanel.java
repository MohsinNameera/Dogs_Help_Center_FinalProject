 ...
 * @author shivibhatt
 */
public class ManageReporterJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageReporterJPanel
     */
    JPanel userProcessContainer;
    EcoSystem ecosystem;
    UserAccountDirectory userAccountList;
   
    public ManageReporterJPanel(JPanel parentContainerPanel,EcoSystem ecosystem) {
        initComponents();
        initListners();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 170, 510, 165));
        ...
        add(createUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 259, -1));

        jLabel3.setText("Password");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, -1, -1));
        add(createPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 180, 259, -1));

        jLabel4.setText("Name");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 230, -1, -1));
        add(createName, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, 259, -1));

        jLabel5.setText("Address");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, -1, -1));
        add(createAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, 259, -1));
        ...
        add(btnCreateCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 420, -1, -1));
        ...
        add(btnModify, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, 82, -1));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, 73, -1));

        jLabel6.setText("Phone");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 340, -1, -1));
        add(createPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 340, 259, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/reportersys.png"))); // NOI18N
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, -1, -1));
    ...
    private void btnCreateCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateCustomerActionPerformed
          ...
          if( createUserName.getText().isEmpty()||createPassword.getText().isEmpty()|| createName.getText().isEmpty() || createAddress.getText().isEmpty() || createPhone.getText().isEmpty())
        {
         ...
         if(ecosystem.getUserAccountDirectory().checkIfUsernameIsUnique(createUserName.getText())){
            Reporter customer = new Reporter(createUserName.getText(), createPassword.getText(), createName.getText(), createAddress.getText(), createPhone.getText());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selectedRow >= 0) {
            Reporter customer = (Reporter) tblCustomer.getValueAt(selectedRow, 0);
           ReporterDirectory customerDirectory = ecosystem.getCustomerDirectory();
     ...
     private void populateTable() {
        ...
        model.setRowCount(0);
        for (Reporter customer : customerDirectory.getCustomerList()) {
    ...
    private void display(Reporter customer) {
