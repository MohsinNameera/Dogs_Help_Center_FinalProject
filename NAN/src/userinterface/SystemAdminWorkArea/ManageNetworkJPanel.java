...
networkJTable.getTableHeader().setDefaultRenderer(new HeaderColors());
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 567, 110));

        jLabel1.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(25, 56, 82));
        jLabel1.setText("STATE NAME");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, 160, 25));

        nameJTextField.setFont(new java.awt.Font("SansSerif", 1, 13)); // NOI18N
        nameJTextField.setForeground(new java.awt.Color(25, 56, 82));
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 280, 296, -1));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, 586, -1));
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, 153, 32));
