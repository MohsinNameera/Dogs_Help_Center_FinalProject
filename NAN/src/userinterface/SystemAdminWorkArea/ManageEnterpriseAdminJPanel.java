...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
 ...
 enterpriseJTable.getTableHeader().setDefaultRenderer(new HeaderColors());
    ...
    private void initComponents() {
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, 400, -1));
        ...
        if(username.isEmpty() || password.isEmpty() || name.isEmpty()){
            ...
            if (system.checkIfUserIsUnique(username)) {
                ...
                if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.EmergencyOperatingUnit) {
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new HelpCenterAdmin());
                } else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.IncidentOperatingUnit) {
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new RescueTeamManager());
                } else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.VoluntaryOperatingUnit) {
                    account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new UnitReportingAdmin());
                }
