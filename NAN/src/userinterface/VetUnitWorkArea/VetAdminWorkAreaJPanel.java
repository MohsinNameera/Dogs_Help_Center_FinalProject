 ...
 */
package userinterface.VetUnitWorkArea;
...
public class VetAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public VetAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem business) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for (WorkRequest wr : organization.getWorkQueue().getWorkRequestList()) {
            if(wr instanceof RescueUnitRequest) {
                ...
                row[9] = ((RescueUnitRequest) wr).getRequirements();
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VETERINARY ADMIN WORK AREA");
        ...
        workRequestTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Report Id", "Sender", "Report Name", "Dogs", "Message", "Status", "Sender Org", "Sender Network", "Requested Date", "Requirements"
            }
        ) {
        ...
        add(processReqBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 350, -1, -1));
        ...
        add(acceptBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, -1, -1));
