 ...
 */
package userinterface.FoodServicesWorkArea;
...
public class FoodServicesAdminWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public FoodServicesAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dog Food Services Management Admin Work Area");
        ...
        workRequestTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Report Id", "Sender", "Report Name", "Dogs", "Message", "Status", "Sender Org", "Sender Network", "Requested Date"
            }
        ) {
        ...
        add(processReqBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 360, -1, -1));
        ...
        add(acceptBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 360, -1, -1));
        ...
        add(rejectBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, -1, -1));
        ...
        add(completeReqBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 360, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fooddogs.gif"))); // NOI18N
