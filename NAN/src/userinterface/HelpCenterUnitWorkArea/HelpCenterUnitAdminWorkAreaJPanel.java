...
public class HelpCenterUnitAdminWorkAreaJPanel extends javax.swing.JPanel {
    
    JPanel userProcessContainer;
    Enterprise enterprise;
    EcoSystem ecosystem;
    /** Creates new form AdminWorkAreaJPanel */
    public HelpCenterUnitAdminWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, EcoSystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.add(manageOrganizationPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 280, 40));
        ...
        jPanel3.add(manageEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 280, 40));
        ...
        jPanel3.add(manageUserAccount, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 280, 40));

        jLabel1.setBackground(new java.awt.Color(215, 81, 81));
        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel1.setText("Dogs Help Center");
    ...
    private void manageOrganization(){
        ...
        HelpCenterManageOrganizationJPanel manageOrganizationJPanel = new HelpCenterManageOrganizationJPanel(rightSystemAdminPanel, enterprise.getOrganizationDirectory(),enterprise);        
    ...
    private void manageEmployee(){
        ...
        manageUserAccount.setBackground(new Color(255,204,0));
        HelpCenterManageEmployeeJPanel manageEmployeeJPanel = new HelpCenterManageEmployeeJPanel(rightSystemAdminPanel, enterprise.getOrganizationDirectory());
        rightSystemAdminPanel.add("HelpCenterManageEmployeeJPanel",manageEmployeeJPanel);
        CardLayout layout = (CardLayout) rightSystemAdminPanel.getLayout();
        layout.next(rightSystemAdminPanel);
    }
    ...
    private void manageUser(){
        ...
        manageOrganizationPanel.setBackground(new Color(255,204,0));
        manageEmployee.setBackground(new Color(255,204,0));
        HelpCenterManageUserAccountJPanel muajp = new HelpCenterManageUserAccountJPanel(rightSystemAdminPanel, enterprise, ecosystem);
        rightSystemAdminPanel.add("HelpCenterManageUserAccountJPanel",muajp);
        CardLayout layout = (CardLayout) rightSystemAdminPanel.getLayout();
        layout.next(rightSystemAdminPanel);
    }
