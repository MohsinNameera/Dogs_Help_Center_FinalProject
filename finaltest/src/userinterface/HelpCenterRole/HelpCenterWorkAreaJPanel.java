...
public class HelpCenterWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public HelpCenterWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecosystem) {
        //this.set
        initComponents();
    ...
    private void manageOrders() {
        ...
        ManageReporterJPanel manageOrderJPanel = new ManageReporterJPanel(rightSystemAdminPanel,ecosystem,userAccount);
    ...
    private void manageMenu() {
        ...
        manageInfoButtonPanel.setBackground(new Color(31,50,97));
        ManageJPanel manageMenuJPanel = new ManageJPanel(rightSystemAdminPanel,userAccount,ecosystem);
