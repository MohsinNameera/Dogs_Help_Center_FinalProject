 ...
 */
package userinterface.HelpCenterRole;
...
public class ManageReporterDetailsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageReporterDetailsJPanel
     */
    ...
    public ManageReporterDetailsJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount account, OrderWorkRequest workRequest) {
        initComponents();
        ...
        deliveryManDirectory = ecosystem.getRescueTeamDirectory();
        populateDeliveryManList(deliveryManDirectory.getRescueTeamList());
        changeButtonText();
        setVisibleEditable();
        display();
    }
    ...
    private void display() {
        ...
        restaurantName.setText(workRequest.getHelpCenter().getName());
    ...
    private void populateDeliveryManUI() {
        if(workRequest.getRescueTeam() == null &&  
            ...
            if(workRequest.getRescueTeam() != null){
                deliveryManNameValue.setText(workRequest.getRescueTeam().getName());
            }else{
      ...
      public void populateDeliveryManList(ArrayList<RescueTeam> deliveryManList) {
        if(workRequest.getRescueTeam() == null) {
            assignDeliveryPerson.setVisible(true);
             for (RescueTeam deliveryMan : deliveryManList) {
    ...
    private void btnBack1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBack1ActionPerformed
        ...
        ManageReporterJPanel manageOrderJPanel = new ManageReporterJPanel(userProcessContainer,ecosystem, account);
    ...
    private void addDeliveryPersonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDeliveryPersonActionPerformed
        // TODO add your handling code here:
        if(index >= 0){
            RescueTeam RescueTeam = deliveryManDirectory.getRescueTeamList().get(index);
            workRequest.setRescueTeam(RescueTeam);
    ...
    private void changeButtonText() {
      ...
      private void setVisibleEditable(){
        if(workRequest.getStatus().equalsIgnoreCase("delivered")){
            ...
            if(workRequest.getReporterFeedback() != null){
                customerFeedbackField.setText(workRequest.getReporterFeedback());
