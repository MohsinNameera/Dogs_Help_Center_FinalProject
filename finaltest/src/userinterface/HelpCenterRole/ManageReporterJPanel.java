...
import userinterface.ReporterRole.ReporterDetailsJPanel;
...
public class ManageReporterJPanel extends javax.swing.JPanel {
    ...
    UserAccount account;
    public ManageReporterJPanel(JPanel userProcessContainer,EcoSystem ecosystem, UserAccount account) {
        initComponents();
        initListners();
     ...
     private void populatRestaurantRequestTable(){
        ...
        model.setRowCount(0);
        workRequestList = ecosystem.getWorkQueue().getWorkRequestListHelpCenter(account);
        for (WorkRequest request : workRequestList) {
            Object[] row = new Object[tblRestaurantWorkRequest.getColumnCount()];
            row[0] = request;
            row[1] = request.getReporter();
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof OrderWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           ManageReporterDetailsJPanel manageOrderDetailsJPanel = new ManageReporterDetailsJPanel(userProcessContainer,ecosystem,account,orderWorkRequest);
