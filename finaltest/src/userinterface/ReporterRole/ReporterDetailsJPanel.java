...
public class ReporterDetailsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ReporterDetailsJPanel
     */
    ...
    public ReporterDetailsJPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount account, OrderWorkRequest workRequest) {
        initComponents();
    ...
    private void display(){
        ...
        if(workRequest.getRescueTeam()!= null){
            deliveryManName.setText(workRequest.getRescueTeam().getName());
        }else
    ...
    private void submitFeedbackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitFeedbackButtonActionPerformed
        ...
        if(!feedback.isEmpty()){
            workRequest.setReporterFeedback(feedback);
            setVisibleEditable();
        }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        // TODO add your handling code here:
            ReporterStatusJPanel ReporterStatusJPanel = new ReporterStatusJPanel(userProcessContainer,ecosystem, account);
            userProcessContainer.add("ReporterStatusJPanel", ReporterStatusJPanel);
