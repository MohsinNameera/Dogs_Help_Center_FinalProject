...
public class ReporterStatusJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ReporterStatusJPanel
     */
    ...
    public ReporterStatusJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount account) {
        initComponents();
        initListners();
    ...
    public void populateRequestTable() {
        ...
        model.setRowCount(0);
        workRequestList = ecosystem.getWorkQueue().getWorkRequestListReporter(account);
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof OrderWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           ReporterDetailsJPanel ReporterDetailsJPanel = new ReporterDetailsJPanel(userProcessContainer,ecosystem,account,orderWorkRequest);
                           userProcessContainer.add("ReporterDetailsJPanel", ReporterDetailsJPanel);
