...
import userinterface.HelpCenterRole.ManageReporterDetailsJPanel;
...
public class RescueTeamWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public RescueTeamWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem ecosystem) {
      ...
      private void populatDeliveryRequestTable(){
        ...
        model.setRowCount(0);
        workRequestList = ecosystem.getWorkQueue().getWorkRequestListRescueTeam(userAccount);
        for (WorkRequest request : workRequestList) {
            Object[] row = new Object[tblDeliveryManWorkRequest.getColumnCount()];
            row[0] = request;
            row[1] = request.getHelpCenter();
            row[2] = request.getReporter();
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof OrderWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           ProcessReportJPanel processOrderJPanel = new ProcessReportJPanel(userProcessContainer,ecosystem,userAccount,orderWorkRequest);
