...
public class ProcessReportJPanel extends javax.swing.JPanel {
     ...
     */
    public ProcessReportJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount account, OrderWorkRequest workRequest) {
        initComponents();
    ...
    private void display() {
        ...
        restaurantNameValue.setText(workRequest.getHelpCenter().getName());
        restaurantAddressValue.setText(workRequest.getReporter().getAddress());
        customerNameValue.setText(workRequest.getReporter().getName());
        customerAddressValue.setText(workRequest.getReporter().getAddress());
